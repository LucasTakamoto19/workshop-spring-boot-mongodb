...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... arg0) throws Exception {
        ...
        Post pos1 = new Post(null, sdf.parse("21/03/2020"), "Partiu Viagem", "Vou viajar para o Chile. Abraços!", maria);
        Post pos2 = new Post(null, sdf.parse("24/03/2020"), "Bom dia", "Acordei no Chile hoje.", maria);
